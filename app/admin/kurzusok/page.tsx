...
export default function AdminKurzusokPage() {
      ...
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <h1 className="font-display text-xl font-bold text-brand-blue">Kurzusok</h1>
          </div>
        ...
        {loading ? (
          ...
          <Card className="text-center py-12">
            <p className="font-sans text-brand-muted">Nincs kurzus. Adj hozzá egyet!</p>
          </Card>
        ) : (
            ...
            {courses.map(c => (
              <Card key={c.id} className="flex items-start justify-between gap-4">
                <div className="flex-1 min-w-0">
                  ...
                  {c.description && (
                    <p className="font-sans text-sm text-brand-muted mb-2 line-clamp-2">{c.description}</p>
                  )}
          ...
          <div className="fixed inset-0 z-50 bg-black/40 flex items-center justify-center p-4">
            <Card className="w-full max-w-lg max-h-[90vh] overflow-y-auto">
              ...
              <form onSubmit={handleSave} className="space-y-4">
                ...
                <Input
                  label="Systeme.io URL (checkout link)"
                ...
                <div className="flex items-center gap-2">
                  ...
                  />
                  <label htmlFor="active" className="font-sans text-sm text-brand-text">
